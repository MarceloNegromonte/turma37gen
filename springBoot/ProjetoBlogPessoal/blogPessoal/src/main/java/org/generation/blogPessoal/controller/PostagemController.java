...
public class PostagemController {
	...
	@PostMapping
	public ResponseEntity<Postagem> post (@RequestBody Postagem postagem){ //requesbody pra pegar o que vem no corpo da requisição
		return ResponseEntity.status(HttpStatus.CREATED).body(repository.save(postagem));
	}
	
	@PutMapping //
	public ResponseEntity<Postagem> put (@RequestBody Postagem postagem){ //requesbody pra pegar o que vem no corpo da requisição
